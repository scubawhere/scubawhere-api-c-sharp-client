...
namespace IO.Swagger.Model
{
    ...
    public partial class Ticket :  IEquatable<Ticket>
    {
        ...
        /// <param name="OnlyPackaged">OnlyPackaged.</param>
        /// <param name="AvailableFrom">AvailableFrom.</param>
        /// <param name="AvailableUntil">AvailableUntil.</param>
        /// <param name="Trips">Trips.</param>
        public Ticket(long? Id = null, string Name = null, string Description = null, bool? OnlyPackaged = null, DateTime? AvailableFrom = null, DateTime? AvailableUntil = null, List<Trip> Trips = null)
        {
            this.Id = Id;
            this.Name = Name;
        ...
        /// <summary>
        /// Gets or Sets OnlyPackaged
        /// </summary>
        [DataMember(Name="only_packaged", EmitDefaultValue=false)]
        ...
        public bool Equals(Ticket other)
        {
            ...
            return 
                ...
                (
                    this.OnlyPackaged == other.OnlyPackaged ||
                    this.OnlyPackaged != null &&
                    this.OnlyPackaged.Equals(other.OnlyPackaged)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OnlyPackaged != null)
                    hash = hash * 59 + this.OnlyPackaged.GetHashCode();
