...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>
    {
        ...
        /// <param name="AddonDecimalPrice">AddonDecimalPrice.</param>
        public InlineResponse2009(string Status = null, string DecimalPrice = null, string AddonDecimalPrice = null)
        {
            this.Status = Status;
            this.DecimalPrice = DecimalPrice;
            this.AddonDecimalPrice = AddonDecimalPrice;
        }
        ...
        /// <summary>
        /// Gets or Sets AddonDecimalPrice
        /// </summary>
        [DataMember(Name="addon_decimal_price", EmitDefaultValue=false)]
        public string AddonDecimalPrice { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AddonDecimalPrice: ").Append(AddonDecimalPrice).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2009 other)
        {
            ...
            return 
                ...
                (
                    this.AddonDecimalPrice == other.AddonDecimalPrice ||
                    this.AddonDecimalPrice != null &&
                    this.AddonDecimalPrice.Equals(other.AddonDecimalPrice)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AddonDecimalPrice != null)
                    hash = hash * 59 + this.AddonDecimalPrice.GetHashCode();
                return hash;
            }
        }
    }
