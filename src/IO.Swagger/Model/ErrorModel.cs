...
namespace IO.Swagger.Model
{
    ...
    public partial class ErrorModel :  IEquatable<ErrorModel>
    {
        ...
        public ErrorModel(string Message = null, List<string> Errors = null)
        {
            ...
            if (Errors == null)
            {
                throw new InvalidDataException("Errors is a required property for ErrorModel and cannot be null");
            }
            else
            {
                this.Errors = Errors;
